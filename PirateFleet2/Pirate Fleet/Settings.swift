...
struct Settings {
    ...
    struct Messages {
        ...
        static var HumanHitSeamonster = "You've awakened a seamonster! RIGHT NOW THE COMPUTER WILL JUST TAKE AN EXTRA TURN..."
        static var ComputerHitSeamonsterTitle = "Sweet!"
        static var ComputerHitSeamonster = "The computer hit a seamonster! RIGHT NOW WE'LL JUST SKIP THE COMPUTER'S NEXT TURN..."
